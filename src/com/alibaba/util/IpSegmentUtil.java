...
public class IpSegmentUtil {
	...
	public static void main(String[] args) {
		String ipSegment = "10.116.48.0/22";
		System.out.println(IpSegmentUtil.getStartIp(ipSegment));
		System.out.println(IpSegmentUtil.getEndIp(ipSegment));
	}
	...
	public static String getStartIp(String segment) {
		...
		String mask = IpSegmentUtil.getNetMask(maskIndex);
